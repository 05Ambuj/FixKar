  ...
  const fetchProfile = async () => {
    ...
    try {
      const response = await axios.get(
        "https://fixkar.onrender.com/accepted-requests",
        {
          headers: {
  ...
  const CompleteRequest = async (requestId) => {
    ...
    try {
      const response = await axios.put(
        `https://fixkar.onrender.com/complete/${requestId}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      if (response.data.status==="accepted") { // Adjust this based on your API response structure
        ...
        Alert.alert("Error", "Failed to mark completion the request.");
      }
    } catch (error) {
          ...
          <View key={task._id} style={styles.taskContainer}>
            ...
            <View style={styles.buttonContainer}>
              <TouchableOpacity
                ...
                onPress={() => CompleteRequest(task._id)}
              >
